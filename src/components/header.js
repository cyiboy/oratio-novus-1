...
function Header(){
    ...
    return(
        <header className="flex w-full items-center sm:justify-between my-3 py-1 sticky inset-0 bg-grey-200 z-50 backdrop-blur-sm">
            <p className="font-bold text-xl xs:text-2xl">Oratio Novus</p>

            {
                location.pathname === '/' &&
                (<>
                    <div className="flex rounded-xl ml-auto bg-white py-2.5 px-3 xs:px-6 basis-0 sm:basis-5/12 md:basis-6/12 lg:basis-7/12 shadow-on-shadow">
                    ...
                    <div className="bg-white flex ml-auto sm:basis-1/12 basis-0 md:basis-2/12 justify-center items-center gap-2 rounded-xl py-2.5 px-3 xs:px-6 shadow-on-shadow">
